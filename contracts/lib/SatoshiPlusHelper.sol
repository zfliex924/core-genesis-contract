...
library SatoshiPlusHelper {
  ...
  uint256 public constant CORE_DECIMAL = 100;
  uint256 public constant CORE_STAKE_DECIMAL = 1000000;
  ...
  uint32 public constant BTC_STAKE_INIT_VERSION = 1;
  uint32 public constant BTC_STAKE_VERSION = 2;
